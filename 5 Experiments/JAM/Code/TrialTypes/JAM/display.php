<?php
    if (!isset($text) || $text === '') { 
        $text = 'How many people out of 100 do you think would respond with the second word if they were only shown the first?|Type your response on a scale from 0-100 and then press Enter.';
    }
