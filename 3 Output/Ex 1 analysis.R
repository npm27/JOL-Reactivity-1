...
##check for outliers
##Start with JOL data
sub1 = JOL[ , c(1, 7, 9)] #JOLs
sub2 = JOL[ , c(1, 7, 13)] #Recall
...
##Start with JOL data
sub3 = FREQ[ , c(1, 7, 9)] #FREQ
sub4 = FREQ[ , c(1, 7, 13)] #Recall
...
length(unique(JOL$Username)) #39
length(unique(FREQ$Username)) #38
